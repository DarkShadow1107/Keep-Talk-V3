...
/**
 * Clasa care defineste setarile unui nivel: timp, numar de module, dificultate etc.
 */
public class Level {
    private String name; // Numele nivelului
    private int time; // Timp disponibil in secunde
    private int moduleCount; // Numarul de module de pe bomba
    private int maxStrikes; // Cate greseli sunt permise
    private String description; // Descrierea misiunii
    private String difficulty; // Categoria de dificultate (EASY, MEDIUM, etc.)
    ...
    /**
     * Defineste lista de niveluri preconfigurate pentru joc.
     * @return O lista cu toate nivelurile disponibile.
     */
    public static List<Level> getLevels() {
        List<Level> levels = new ArrayList<>();
        
        // DIFICULTATE: USOR (5 Niveluri)
